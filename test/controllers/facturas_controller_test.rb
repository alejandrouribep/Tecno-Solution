...
class FacturasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create factura" do
    assert_difference('Factura.count') do
      post facturas_url, params: { factura: { clients_id: @factura.clients_id, details: @factura.details, fecha: @factura.fecha, price: @factura.price, products_id: @factura.products_id, services_id: @factura.services_id, users_id: @factura.users_id } }
    end
  ...
  test "should update factura" do
    patch factura_url(@factura), params: { factura: { clients_id: @factura.clients_id, details: @factura.details, fecha: @factura.fecha, price: @factura.price, products_id: @factura.products_id, services_id: @factura.services_id, users_id: @factura.users_id } }
