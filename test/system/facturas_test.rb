...
class FacturasTest < ApplicationSystemTestCase
  ...
  test "creating a Factura" do
    ...
    fill_in "Clients", with: @factura.clients_id
    fill_in "Details", with: @factura.details
    fill_in "Fecha", with: @factura.fecha
    fill_in "Price", with: @factura.price
    fill_in "Products", with: @factura.products_id
    fill_in "Services", with: @factura.services_id
    fill_in "Users", with: @factura.users_id
